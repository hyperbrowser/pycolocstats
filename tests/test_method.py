...
def tracks():
    return [TrackFile(pkg_resources.resource_filename('conglomerate', '../tests/resources/H3K4me1_no_overlaps.bed'),''),
            TrackFile(pkg_resources.resource_filename('conglomerate', '../tests/resources/H3K4me3_no_overlaps.bed'),''),
            TrackFile(pkg_resources.resource_filename('conglomerate', '../tests/resources/H3K4me1_with_overlaps.bed'),''),
            TrackFile(pkg_resources.resource_filename('conglomerate', '../tests/resources/H3K4me3_with_overlaps.bed'),''),
            TrackFile(pkg_resources.resource_filename('conglomerate', '../tests/resources/H3K4me1_no_overlaps.bed.gz'),''),
            TrackFile(pkg_resources.resource_filename('conglomerate', '../tests/resources/H3K4me3_no_overlaps.bed.gz'),''),
            TrackFile(pkg_resources.resource_filename('conglomerate', '../tests/resources/H3K4me1_with_overlaps.bed.gz'),''),
            TrackFile(pkg_resources.resource_filename('conglomerate', '../tests/resources/H3K4me3_with_overlaps.bed.gz'),''),
            TrackFile(pkg_resources.resource_filename('conglomerate', '../tests/resources/H3K4me1_no_overlaps_cropped.bed'),''),
            TrackFile(pkg_resources.resource_filename('conglomerate', '../tests/resources/H3K4me1_no_overlaps_large.bed.gz'),''),
            TrackFile(pkg_resources.resource_filename('conglomerate', '../tests/resources/H3K4me3_no_overlaps_large.bed.gz'),''),
            TrackFile(pkg_resources.resource_filename('conglomerate', '../tests/resources/Refseq_Genes_cropped.bed.gz'),''),
            TrackFile(pkg_resources.resource_filename('conglomerate', '../tests/resources/Ensembl_Genes_cropped.bed.gz'),''),
            TrackFile(pkg_resources.resource_filename('conglomerate', '../tests/resources/H3K4me3_no_overlaps_cropped.bed'),'')]
